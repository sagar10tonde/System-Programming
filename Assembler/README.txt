...
pucsd -$ ./puasm.py add.asm                       => Get Output of asm file
pucsd -$ ./puasm.py add.asm -s                    => display symbol table
pucsd -$ ./puasm.py add.asm -l                    => display literal table
pucsd -$ ./puasm.py add.asm -i                    => display Intermediate code
pucsd -$ ./puasm.py add.asm -lst                  => display lst file code
pucsd -$ ./puasm.py add.asm -o                    => display object code
pucsd -$ ./puasm.py add.asm -lst I anyfile.lst    => store lst file in enter anyfile.lst name
pucsd -$ ./puasm.py add.asm -o   I anyfile.txt    => store obj code in enter anyfile.txt name

MACRO
pucsd -$ ./puasm.py macro.asm                     => Get Output of macro_asm file
pucsd -$ ./puasm.py macro.asm -e                  => display macro expansion code
pucsd -$ ./puasm.py macro.asm -mt                 => display macro   table (MNT & MDT)
pucsd -$ ./puasm.py macro.asm -ms                 => display symbol  table
pucsd -$ ./puasm.py macro.asm -ml                 => display literal table
pucsd -$ ./puasm.py macro.asm -mi                 => display Intermediate code
pucsd -$ ./puasm.py macro.asm -mlst               => display lst file code
pucsd -$ ./puasm.py macro.asm -mo                 => display object code
pucsd -$ ./puasm.py macro.asm -mlst I anyfile.lst => store lst file in enter anyfile.lst name
pucsd -$ ./puasm.py macro.asm -mo I anyfile.txt   => store obj code in enter anyfile.txt name
